...
saveRDS(bayes_results_all, "simulations/sim_DpR_unconstrained_bayes_results_df.rds")


# Analysis -------------------------------------------------------------

bayes_results_all <- readRDS("simulations/sim_DpR_unconstrained_bayes_results_df.rds")
