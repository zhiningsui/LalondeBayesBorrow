...
saveRDS(bayes_results, file = "output_paper/casestudy_OR_bayes_results_2.rds")
...
ggsave("output_paper/casestudy_zone_size_vs_trt_orr.jpg", p2, width = 8, height = 3.5)
...
ggsave("output_paper/casestudy_analysis.jpg", p_combined, width = 17, height = 8)
